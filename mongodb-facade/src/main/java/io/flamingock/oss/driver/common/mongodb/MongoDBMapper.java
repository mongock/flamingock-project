...
import static io.flamingock.oss.internal.persistence.EntryField.KEY_CHANGELOG_CLASS;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_CHANGESET_METHOD;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_CHANGE_ID;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_ERROR_TRACE;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_EXECUTION_HOSTNAME;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_EXECUTION_ID;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_EXECUTION_MILLIS;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_METADATA;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_STATE;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_SYSTEM_CHANGE;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_TIMESTAMP;
import static io.flamingock.oss.internal.persistence.EntryField.KEY_TYPE;
