...
@Testcontainers
class MongoSync4CloudImporterTest {
    ...
    private static MongockLegacyAuditEntry toMongockLegacyAuditEntry(Document document) {
    ...
    void shouldRunMongockImporter() {
        ...
        List<MongockLegacyAuditEntry> importExpectations = mongockDbState
                .stream()
                .map(MongoSync4CloudImporterTest::toMongockLegacyAuditEntry)
        ...
        flamingockBuilder
                ...
                .addStage(new Stage(stageName).addCodePackage("io.flamingock.importer.cloud.mongodb.v4.changes"))
