...
public class SpringDataMongoV3Configuration extends MongoDBDriverConfiguration {

    public static SpringDataMongoV3Configuration getDefault() {
        return new SpringDataMongoV3Configuration();
    }
