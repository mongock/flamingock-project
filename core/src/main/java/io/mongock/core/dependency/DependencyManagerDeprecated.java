...
public class DependencyManagerDeprecated {
    ...
    public DependencyManagerDeprecated() {
    ...
    public DependencyManagerDeprecated setLockGuardProxyFactory(LockGuardProxyFactory lockGuardProxyFactory) {
     ...
     */
    public DependencyManagerDeprecated addDriverDependencies(Collection<? extends ChangeSetDependency> dependencies) {
        dependencies.forEach(this::addDriverDependency);
        return this;
    }

    public DependencyManagerDeprecated addDriverDependency(ChangeSetDependency dependency) {
        return addDependency(connectorDependencies, dependency);
    }

    public DependencyManagerDeprecated addStandardDependencies(Collection<? extends ChangeSetDependency> dependencies) {
        dependencies.forEach(this::addStandardDependency);
        return this;
    }

    public DependencyManagerDeprecated addStandardDependency(ChangeSetDependency dependency) {
        return addDependency(standardDependencies, dependency);
    }

    private <T extends ChangeSetDependency> DependencyManagerDeprecated addDependency(Collection<T> dependencyStore, T dependency) {
