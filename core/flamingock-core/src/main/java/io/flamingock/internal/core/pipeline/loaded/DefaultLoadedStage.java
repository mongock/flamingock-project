 ...
 */
public class DefaultLoadedStage extends LoadedStage {
    ...
    public List<ValidationError> getValidationErrors() {
        ...
        Collection<AbstractLoadedTask> loadedTasks = getLoadedTasks();
        if (loadedTasks == null || loadedTasks.isEmpty()) {
            String message = String.format("Stage[%s] must contain at least one task", getName());
            return Collections.singletonList(new ValidationError(message, getName(), "stage"));
        }
