...
public class ChangesPreProcessor extends AbstractProcessor {
    ...
    public Set<String> getSupportedAnnotationTypes() {
        return new HashSet<>(Collections.singletonList(
                ChangeUnitSource.class.getCanonicalName()
        ));
    }
    ...
    private PreviewPipeline getPipelineFromProcessChanges(Map<String, List<CodedPreviewChangeUnit>> codedChangeUnitsByPackage) {
        ...
        try (InputStream inputStream = Files.newInputStream(pipelineFile.toPath())) {
            ...
            for (Map<String, String> stageMap : stageList) {
                ...
                Collection<CodedPreviewChangeUnit> changeUnitClasses = codedChangeUnitsByPackage.get(sourcesPackage);
