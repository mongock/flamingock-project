...
public class SpringDataMongoV2DocumentWrapper implements DocumentWrapper {

    private final Document document;

    public SpringDataMongoV2DocumentWrapper(Document document) {
    ...
    public DocumentWrapper getWithWrapper(String key) {
        return new SpringDataMongoV2DocumentWrapper((Document) get(key));
    }
}
